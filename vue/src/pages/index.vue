    ...
    <div class="index-page">
      <div class="info">
        <div class="container">
          ...
          <div class="title">Bribe Farm</div>
          <div class="balance">
            <div class="balance__inner">
              <div class="balance__item">
                <div class="balance__title">Your Bribe Balance</div>
                ...
                <div class="balance__total">
                  ...
                  <div class="balance__total-cost">{{ toFixedTwo(rewardPerToken / 1e18) }} BRIBE</div>
                </div>
              </div>
            ...
            <div class="balance__info">
              ...
              <div class="balance__name">Pro Tip</div> - Add your Uniswap BRIBE-ETH LPs liquidity provider tokens to farm ROOBEE
            </div>
